...
WALLET_ROOT=$$PWD/shekyl

CONFIG += c++11

# cleaning "auto-generated" shekyl directory on "make distclean"
...
linux {
   ...
   #     }
    ...
    # currently shekyl has an issue with "static" build and linunwind-dev,
...
DISTFILES += \
    notes.txt \
    shekyl/src/wallet/CMakeLists.txt \
    components/MobileHeader.qml


# windows application icon
RC_FILE = shekyl-core.rc
